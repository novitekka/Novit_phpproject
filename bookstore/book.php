  ...
  <li class="list-group-item">MISCELLANEOUS</li>
    ...
    <span class="col-lg-10">
     <?php 
       ...
       $the_book=mysqli_query($connection,$query);     
        if(!$the_book)
        {
            echo "query failed";
        }
       while($row=mysqli_fetch_assoc($the_book))
        {   
   ...
   <div class="card col-lg-10 mr-2 ml-2 mb-4" style="margin: 0 auto"><br>
     <img class="card-img-top" style="width:250px; height:300px; margin: 0 auto" src="images/<?php echo $the_book_image; ?>" alt="Book image">
  <div class="card-body">
    ...
    <a href="" class="btn btn-primary btn-lg">Buy it now</a><br>
  </div>
